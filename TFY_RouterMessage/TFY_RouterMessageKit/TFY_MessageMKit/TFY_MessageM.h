 ...
 */
- (void)tfy_addListener:(id)listener
...
/**
 ...
 message 消息
 */
- (void)tfy_removeListener:(id)listener
            forMessage:(NSString *)message;
...
/**
 ...
 object 消息发送内容
 */
- (void)tfy_sendMessage:(NSString *)message
...
/** 消息名称 */
@property(nonatomic, copy, readonly)NSString *tfy_name;

/** 消息体 */
@property(nonatomic, strong, readonly)id tfy_object;

/** 消息附属内容 */
@property(nonatomic, copy, readonly)NSDictionary *tfy_userInfo;
/**
 初始化消息
 name 名称
 object 消息体
