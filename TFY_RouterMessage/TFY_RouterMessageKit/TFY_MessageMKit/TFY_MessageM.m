 ...
 */
- (void)tfy_addListener:(id)listener forMessage:(NSString *)message selector:(SEL)selector;{
    TFY_MessageMLock();
...
/**
 ...
 block 执行回调
 */
- (void)tfy_addListener:(id)listener forMessage:(NSString *)message usingBlock:(nullable MessageMCompletionBlock)block;{
    TFY_MessageMLock();
    NSMapTable *listerMap = [messageListeners objectForKey:message];
    if (!listerMap) {
        listerMap = [NSMapTable mapTableWithKeyOptions:NSMapTableWeakMemory
...
/**
 ...
 message 消息
 */
- (void)tfy_removeListener:(id)listener forMessage:(NSString *)message;{
    TFY_MessageMLock();
    NSMapTable *listerMap = [messageListeners objectForKey:message];
    if (listerMap) {
...
/**
 ...
 object 消息发送内容
 */
- (void)tfy_sendMessage:(NSString *)message object:(nullable id)object;{
    [self tfy_sendMessage:message object:object userInfo:nil];
}
...
/**
 ...
 userInfo 附属内容
 */
- (void)tfy_sendMessage:(NSString *)message object:(nullable id)object userInfo:(nullable NSDictionary *)userInfo;{
